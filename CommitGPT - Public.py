...
while True:
    ...
    if user_input == "y":
        ...
        if modified_files:
            ...
            input("Commit effectué avec succès. Appuyez sur Entrée...")
        break
    elif user_input == "n":
        ...
        print("Veuillez entrer (y) Oui, (n) Non ou (q) Quitter")